...
namespace Marina_Club.Controllers
{
    ...
    public class SchedulesController : ApiController
    {
        ...
        //    if (result == null)
        //        return BadReq(ApiMessage.SchedulesNotExist, new { Reason = $"1-no schedule in this eFun, 2-wrong eFun id" });
        ...
        //    var result = await _scheduleService.GetAllSchedulesForFun(id);
        //    if (result == null)
        //        return BadReq(ApiMessage.SchedulesNotExist, new { Reason = $"1-no schedule in this eFun, 2-eFun not found" });
        ...
        ///// </summary>
        //[HttpPut("DiscountPercentFun/{id}")] // eFun id
        ...
        //    if (result == null)
        //        return BadReq(ApiMessage.InvalidFunId, new { Reason = $"1-eFun not found, 2-eFun not have any schedule, 3-there is a problem when saveChanges. TryAgain!" });
        //    return OkResult(ApiMessage.ListDiscountPricePercent, new { ChangedSchedules = result });
        //}
        ...
        ///// </summary>
        //[HttpPut("DiscountPriceFun/{id}")] //eFun id 
        ...
        ///// </summary>
        //[HttpPut("IncreaseFunPricePercent/{id}")] //eFun id
        ...
        ///// </summary>
        //[HttpPut("IncreaseFunPrice/{id}")] //eFun id
        ...
        //    if (result == null)
        //        return BadReq(ApiMessage.NoScheduleAtThisTime, new { Reason = $"1-no schedule in this date time, 2-wrong eFun id" });
