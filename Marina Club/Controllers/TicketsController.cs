...
namespace Marina_Club.Controllers
{
    ...
    public class TicketsController : ApiController
    {
        ...
        public async Task<IActionResult> GetAllFunTicketsWithFunID(Guid id)
        {
            ...
            if (result == null)
                return BadReq(ApiMessage.FunNotHaveTickets, new { Reasons = $"1-fun not have any ticket, 2-fun id is wrong" });
        ...
        public async Task<IActionResult> AllFunInActiveTickets(Guid id)
        {
            ...
            if (result == null)
                return BadReq(ApiMessage.FunNotHaveInActiveTickets, new { Reasons = $"1-fun not have any inActive ticket, 2-fun id is wrong" });
        ...
        public async Task<IActionResult> GetAllFunActiveTicketsWithFunID(Guid id)
        {
            ...
            if (result == null)
                return BadReq(ApiMessage.FunNotHaveActiveTickets, new { Reasons = $"1-fun not have any reserved ticket, 2-fun id is wrong" });
        ...
        public async Task<IActionResult> GetAllFunCanceledTicketsWithFunID(Guid id)
        {
            ...
            if (result == null)
                return BadReq(ApiMessage.FunNotHaveCanceledTickets, new { Reasons = $"1-fun not have any canceled ticket, 2-fun id is wrong" });
        ...
        public async Task<IActionResult> AllFunInActiveTicketsCount(Guid id)
        {
            var result = await _ticketService.AllFunInActiveTickets(id);
            if (result == null)
                return OkResult(ApiMessage.AllFunInActiveTicketsCountGetted, new { AllFunInActiveTicketsCount = $"0 - fun not have any inActive ticket" });
        ...
        public async Task<IActionResult> ReservationFunTicketsCount(Guid id)
        {
            var result = await _ticketService.GetAllFunActiveTicketsWithFunID(id);
            if (result == null)
                return OkResult(ApiMessage.AllFunReservedTicketsCountGetted, new { ReservationFunTicketsCount = $"0 - fun not have any reserved ticket" });
        ...
        public async Task<IActionResult> CanceledFunTicketsCount(Guid id)
        {
            var result = await _ticketService.GetAllFunCanceledTicketsWithFunID(id);
            if (result == null)
                return OkResult(ApiMessage.AllFunCanceledTicketsCountGetted, new { CanceledFunTicketsCount = $"0 - fun not have any canceled ticket" });
        ...
        public async Task<IActionResult> AddTicketForBasket(Guid id, AddTicketToBasketCommand command)
        {
            command.UserId = id;
            if (!command.Validate())
            ...
            var result = await _ticketService.AddTicketForBasket(command);
            if (result == null)
